  ...
  return (
    <div
      className={cn(
        ...
        "flex flex-col md:flex-row xl:flex-col md:py-9 xl:py-0"
      )}
    >
      <div className="grow">
        <div className="flex flex-col md:flex-row xl:flex-col justify-normal md:justify-between xl:justify-center relative">
          <Image
            src={CardDesignImage}
            alt=""
            className="absolute rotate-0 -top-8 left-1/2 -translate-x-1/2 md:-rotate-90 md:-top-2 md:left-16 xl:rotate-0 xl:-top-8 xl:left-1/2 xl:-translate-x-1/2"
          />

          <div
            className={cn(
              "rounded-full h-52 w-72 opacity-45 blur-3xl left-1/2 -translate-x-1/2 -top-28 md:-left-0 md:-top-8 xl:left-1/2 xl:-translate-x-1/2 xl:-top-28 absolute",
              ellipseColor
            )}
          ></div>
          <div className="flex md:-rotate-90 xl:rotate-0 items-center justify-center mt-14 md:mt-0 xl:mt-14">
            <div
              className={cn(
          ...
          <div className="mt-10 md:mt-0 xl:mt-10 flex flex-col items-center justify-center">
            ...
            <div className="hidden md:flex items-center justify-center mt-3 xl:hidden">
              <Link href={"/plan/isp"}>
                <Button
          ...
          <div className="mt-8 md:mt-0 xl:mt-8 bg-darkmode-300 border border-darkmode-100 rounded-lg p-4 mx-8">
            ...
            <div className="mt-6 flex items-center gap-1">
              <p className="text-sm font-semibold text-grey-50">
                ${totalPrice}
              </p>
      ...
      <div className="xl:flex items-center justify-center mb-9 mt-8 xl:mt-0 flex md:hidden">
        <Link href={"/plan/isp"}>
          <Button
            className="py-3 px-11"
            icon={<Image src={ShoppingCartIcon} alt="" />}
