  ...
  return (
    <div>
      <div className="border border-darkmode-100 bg-darkmode-300 rounded-xl">
        <div>
          <div className="flex flex-wrap items-center justify-between *:p-2 border-b border-darkmode-100">
            <div className="flex flex-col lg:flex-row gap-[10px] lg:gap-0 justify-between px-[30px] pb-[30px]">
              <div className="flex gap-1 md:gap-4 *:rounded-md *:px-4 *:md:px-6 *:py-2.5 *:text-white *:text-sm overflow-auto whitespace-nowrap">
                <button
          ...
          <div className="flex items-center justify-center gap-3 md:hidden border-t border-darkmode-100 p-3">
            <Button
              onClick={onDownloadClick}
              icon={
                <Image
